...
export default function HeroMobile({ onAddressSubmit, lang = "en" }: HeroMobileProps) {
  const c = content[lang].mobileHero;
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        >
          {c.headline}{" "}
          <span className="italic text-gradient-gold block">{c.headlineItalic}</span>
        </motion.h1>
