...
export default function ServiceArea({ lang = "en" }: { lang?: Locale }) {
  const c = content[lang].serviceArea;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            >
              ...
              <div>
                <p className="text-cream/70 text-sm font-body font-medium mb-1">{c.notSureLabel}</p>
                <p className="text-cream/40 text-sm font-body">{c.notSureSub}</p>
              </div>
            </motion.div>
